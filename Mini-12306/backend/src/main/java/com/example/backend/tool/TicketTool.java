...
public class TicketTool {
    ...
    @Tool(description = "查询车次信息，可以根据出发站、到达站和出发日期查询")
    public String queryTrainSchedules(String sessionId, String departureStation, String arrivalStation, String departureDate) {
        try {
            ...
            chatSessionService.sendComponentToSession(sessionId, "train_list", componentData);
